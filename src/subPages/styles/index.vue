...
<template>
  <view class="min-h-screen flex-col gap-y-3 py-3">
      ...
      <template #description>
        <view class="grid grid-cols-2 gap-3">
          ...
          >
            ...
            <view class="mb-2 text-3 leading-snug">
              {{ feature.desc }}
            </view>
    ...
    <!-- 颜色系统 -->
    <demo-block title="颜色系统">
      <view
        v-for="category in colorCategories"
        :key="category.name"
        class="flex-col gap-y-3"
      >
    ...
    <!-- 布局系统 -->
    <demo-block title="布局系统">
      <view
        v-for="example in layoutExamples"
        :key="example.title"
        class="flex-col gap-y-3 rounded-2 bg-white dark:bg-[var(--wot-dark-background2)]"
      >
    ...
    <demo-block title="间距系统">
      ...
      <view class="text-2.5 text-gray-500 dark:text-[var(--wot-dark-color2)]">
        💡 提示：p-1 = 4px, p-2 = 8px, p-4 = 16px, p-6 = 24px, p-8 = 32px
      </view>
    </demo-block>

    <!-- 字体系统 -->
    <demo-block title="字体系统">
      <view class="text-4 text-gray-800 font-bold dark:text-[var(--wot-dark-color)]">
        字体大小
      </view>
    ...
    <demo-block title="交互效果">
      <!-- 悬停效果 -->
      <view class="rounded-2 bg-white dark:bg-[var(--wot-dark-background2)]">
